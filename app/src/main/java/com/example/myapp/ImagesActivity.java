...
public class ImagesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.log("22222222222222", "66666666666");
    ...
    public void setImageList() {
        ...
        imageAdapter = new com.example.myapp.ImageAdapter(getApplicationContext(), imageList);
    ...
    public void setSelectedImageList() {
        ...
        selectedImageAdapter = new com.example.myapp.SelectedImageAdapter(this, selectedImageList);
